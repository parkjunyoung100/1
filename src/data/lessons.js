export const lessons = [
  {
    ...
    content: `C 언어는 1972년 데니스 리치가 만든 프로그래밍 언어예요.
운영체제, 게임, 임베디드 기기 등에 널리 사용돼요.

**C 언어의 특징**
- 실행 속도가 매우 빠름 (컴파일 언어)
- 메모리를 직접 다룰 수 있음 (포인터)
- 다른 언어의 기초가 됨 (Java, C++, C#)
...
int main() {
  ...
  },
  {
    ...
    content: `변수는 값을 저장하는 상자예요. 자료형은 이 상자의 크기예요.

**기본 자료형**
- \`int\` : 정수 (4바이트, -21억~21억)
- \`float\` : 실수 (4바이트)
- \`double\` : 더 정확한 실수 (8바이트)
- \`char\` : 문자 1개 (1바이트)
...
int main() {
  ...
  {
    id: 4, title: '연산자', icon: '➕',
    content: `값을 계산하고 비교하는 연산자들을 배워요.
...
\`\`\`c
int a = 5;
int b = ++a; // a=6, b=6 (먼저 증가)
int c = a++; // a=7, c=6 (증가 전 값)
\`\`\`
