export const exercises = [
  {
    ...
    testCases: [
      { input: "4", expected: "4는 짝수입니다." },
      { input: "7", expected: "7는 홀수입니다." },
      { input: "0", expected: "0는 짝수입니다." },
      { input: "-3", expected: "-3는 홀수입니다." },
    ],
...
int main() {
  ...
  },
  {
    ...
    testCases: [
      { input: "12 18", expected: "GCD(12, 18) = 6" },
      { input: "7 13", expected: "GCD(7, 13) = 1" },
      { input: "100 25", expected: "GCD(100, 25) = 25" },
    ],
    solution: `#include <stdio.h>

// 유클리드 호제법: a를 b로 나눈 나머지로 b를 반복해서 나눔
int gcd(int a, int b) {
    while (b != 0) {
        int temp = b;
        b = a % b;  // a를 b로 나눈 나머지
