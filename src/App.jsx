    ...
    switch (page) {
      ...
      case 'lessons':
        return lessonId !== null
          ? <LessonView lessonId={lessonId} onBack={() => setLessonId(null)} onNext={() => navigate('quizzes')} onQuiz={(qid) => { setQuizId(qid); setPage('quizzes'); }} />
      ...
      case 'battle':
        return <BattleView onBack={() => navigate('home')} />;
      default:
        return <Home stats={stats} onNavigate={navigate} />;
    }
  };
